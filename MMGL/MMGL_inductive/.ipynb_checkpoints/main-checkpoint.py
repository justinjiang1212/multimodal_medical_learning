...
def train_and_eval(datadir, datname, hyperpm):
    ...
    modal_feat_dict = np.load('../data/TADPOLE/tadpole_challenge/TADPOLE/modal_feat_dict.npy', allow_pickle=True).item()
    data = pd.read_csv('../data/TADPOLE/tadpole_challenge/TADPOLE/processed_standard_data.csv').values
